# модель построения Графов + метод обхода в глубину + метод обхода в ширину

class Stack:  # стек для поиска в глубину
...
class Queue:  # очередь для поиска в ширину
...
class SimpleGraph:
    ...
    def DepthFirstSearch(self, VFrom, VTo):
        ...
        return: список вершин пути из VFrom в VTo или [] если пути нет
        '''
